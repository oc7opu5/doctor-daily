  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5 md:space-y-6">
      <div>
        ...
        <p className="text-dark-400 text-sm md:text-base mt-1">Configure your AI provider.</p>
      </div>

      <div className="bg-dark-900 rounded-xl p-4 md:p-6 border border-dark-700 space-y-5 md:space-y-6">
        <div>
              ...
              <label
                ...
                className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-colors ${
                  selected === key
                    ...
                    : 'border-dark-600 bg-dark-800 active:bg-dark-700'
                }`}
              >
                <input
                  type="radio"
                ...
                {key === 'opencode' && <span className="text-xs text-brand-400 bg-brand-600/20 px-2 py-1 rounded-full shrink-0">Recommended</span>}
              </label>
            ))}
          </div>
        </div>
        ...
        <button
          onClick={handleSave}
          disabled={loading}
          className="flex items-center justify-center gap-2 w-full md:w-auto px-6 py-2.5 bg-brand-600 hover:bg-brand-700 text-white rounded-lg transition-colors disabled:opacity-50 font-medium"
        >
      ...
      <div className="bg-dark-900 rounded-xl p-4 md:p-6 border border-dark-700">
        <h2 className="text-base md:text-lg font-semibold text-white mb-3">About Doctor Daily</h2>
